...
class CaracteristicaResourceIT {
    ...
    private static final Long DEFAULT_ID_EXTERNO = 1L;
    private static final Long UPDATED_ID_EXTERNO = 2L;
    ...
    public static Caracteristica createUpdatedEntity(EntityManager em) {
        Caracteristica updatedCaracteristica = new Caracteristica()
    ...
    @Test
    @Transactional
    void checkIdExternoIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        caracteristica.setIdExterno(null);
    ...
    void getAllCaracteristicas() throws Exception {
        ...
        restCaracteristicaMockMvc
            ...
            .andExpect(jsonPath("$.[*].idExterno").value(hasItem(DEFAULT_ID_EXTERNO.intValue())))
    ...
    void getCaracteristica() throws Exception {
        ...
        restCaracteristicaMockMvc
            ...
            .andExpect(jsonPath("$.idExterno").value(DEFAULT_ID_EXTERNO.intValue()))
    ...
    void putExistingCaracteristica() throws Exception {
        ...
        updatedCaracteristica.idExterno(UPDATED_ID_EXTERNO).nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION);
    ...
    void partialUpdateCaracteristicaWithPatch() throws Exception {
        ...
        partialUpdatedCaracteristica.idExterno(UPDATED_ID_EXTERNO);
    ...
    void fullUpdateCaracteristicaWithPatch() throws Exception {
        ...
        partialUpdatedCaracteristica.idExterno(UPDATED_ID_EXTERNO).nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION);
