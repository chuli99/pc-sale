...
export const Dispositivo = () => {
  ...
  const totalItems = useAppSelector(state => state.dispositivo.totalItems);
  const links = useAppSelector(state => state.dispositivo.links);
  const entity = useAppSelector(state => state.dispositivo.entity);
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="servidorApiApp.dispositivo.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('codigo')}>
                    <Translate contentKey="servidorApiApp.dispositivo.codigo">Codigo</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('nombre')}>
                    <Translate contentKey="servidorApiApp.dispositivo.nombre">Nombre</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('descripcion')}>
                    <Translate contentKey="servidorApiApp.dispositivo.descripcion">Descripcion</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('precioBase')}>
                    <Translate contentKey="servidorApiApp.dispositivo.precioBase">Precio Base</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('moneda')}>
                    <Translate contentKey="servidorApiApp.dispositivo.moneda">Moneda</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
                  ...
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td className="text-end">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button
                          tag={Link}
                          to={`/dispositivo/${dispositivo.id}/delete`}
                          color="danger"
                          size="sm"
