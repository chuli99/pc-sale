...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISPOSITIVO_LIST actions', async () => {
    ...
    it('dispatches FETCH_DISPOSITIVO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISPOSITIVO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISPOSITIVO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISPOSITIVO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISPOSITIVO actions', async () => {
      const expectedActions = [
        {
