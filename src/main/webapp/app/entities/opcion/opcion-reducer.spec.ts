...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './opcion.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPCION_LIST actions', async () => {
    ...
    it('dispatches FETCH_OPCION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OPCION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OPCION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OPCION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OPCION actions', async () => {
      const expectedActions = [
        {
