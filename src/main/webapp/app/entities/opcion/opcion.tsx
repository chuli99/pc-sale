...
import { getEntities, reset } from './opcion.reducer';
...
export const Opcion = () => {
  ...
  const totalItems = useAppSelector(state => state.opcion.totalItems);
  const links = useAppSelector(state => state.opcion.links);
  const entity = useAppSelector(state => state.opcion.entity);
  ...
  return (
    <div>
      <h2 id="opcion-heading" data-cy="OpcionHeading">
        <Translate contentKey="servidorApiApp.opcion.home.title">Opcions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="servidorApiApp.opcion.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/opcion/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="servidorApiApp.opcion.home.createLabel">Create new Opcion</Translate>
          </Link>
        </div>
      </h2>
      <div className="table-responsive">
        <InfiniteScroll
          dataLength={opcionList ? opcionList.length : 0}
          next={handleLoadMore}
          ...
          {opcionList && opcionList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="servidorApiApp.opcion.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('codigo')}>
                    <Translate contentKey="servidorApiApp.opcion.codigo">Codigo</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('nombre')}>
                    <Translate contentKey="servidorApiApp.opcion.nombre">Nombre</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('descripcion')}>
                    <Translate contentKey="servidorApiApp.opcion.descripcion">Descripcion</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td className="text-end">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button tag={Link} to={`/opcion/${opcion.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="servidorApiApp.opcion.home.notFound">No Opcions found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
