...
describe('Dispositivos Management Component', () => {
  let comp: DispositivosComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'dispositivos', component: DispositivosComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(DispositivosComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to dispositivosService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDispositivosIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDispositivosIdentifier).toHaveBeenCalledWith(entity);
