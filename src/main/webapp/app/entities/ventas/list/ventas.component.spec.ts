...
describe('Ventas Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ventas', component: VentasComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to ventasService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getVentasIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getVentasIdentifier).toHaveBeenCalledWith(entity);
