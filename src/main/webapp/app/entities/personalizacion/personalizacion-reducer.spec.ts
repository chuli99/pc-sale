...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERSONALIZACION_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERSONALIZACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERSONALIZACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERSONALIZACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERSONALIZACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERSONALIZACION actions', async () => {
      const expectedActions = [
        {
