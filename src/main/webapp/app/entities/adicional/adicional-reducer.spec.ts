...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './adicional.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADICIONAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_ADICIONAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADICIONAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADICIONAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADICIONAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADICIONAL actions', async () => {
      const expectedActions = [
        {
