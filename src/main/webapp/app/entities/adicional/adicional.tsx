...
export const Adicional = () => {
  ...
  const totalItems = useAppSelector(state => state.adicional.totalItems);
  const links = useAppSelector(state => state.adicional.links);
  const entity = useAppSelector(state => state.adicional.entity);
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="servidorApiApp.adicional.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('nombre')}>
                    <Translate contentKey="servidorApiApp.adicional.nombre">Nombre</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('descripcion')}>
                    <Translate contentKey="servidorApiApp.adicional.descripcion">Descripcion</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('precio')}>
                    <Translate contentKey="servidorApiApp.adicional.precio">Precio</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('precioGratis')}>
                    <Translate contentKey="servidorApiApp.adicional.precioGratis">Precio Gratis</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                  ...
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td className="text-end">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button tag={Link} to={`/adicional/${adicional.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
