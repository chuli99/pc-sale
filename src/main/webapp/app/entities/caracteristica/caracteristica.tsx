...
export const Caracteristica = () => {
  ...
  const totalItems = useAppSelector(state => state.caracteristica.totalItems);
  const links = useAppSelector(state => state.caracteristica.links);
  const entity = useAppSelector(state => state.caracteristica.entity);
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="servidorApiApp.caracteristica.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('nombre')}>
                    <Translate contentKey="servidorApiApp.caracteristica.nombre">Nombre</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td className="text-end">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button
                          tag={Link}
                          to={`/caracteristica/${caracteristica.id}/delete`}
                          color="danger"
                          size="sm"
