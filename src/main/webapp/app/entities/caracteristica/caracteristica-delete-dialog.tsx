...
export const CaracteristicaDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="servidorApiApp.caracteristica.delete.question">
        <Translate contentKey="servidorApiApp.caracteristica.delete.question" interpolate={{ id: caracteristicaEntity.id }}>
