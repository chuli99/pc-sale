...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARACTERISTICA_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARACTERISTICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARACTERISTICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARACTERISTICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARACTERISTICA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARACTERISTICA actions', async () => {
      const expectedActions = [
        {
